                  ...
                  {!! Form::open(['action' => ['Admin\ProductController@update', $product->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            {{ Form::text('nama_barang', $product->nama_barang, ['class' => 'form-control', 'placeholder' => 'Contoh : Ikan Salmon', 'autocomplete' => 'off', 'required']) }}
                        </div>
                        <div class="col-lg-6">
                            {{ Form::label('deskripsi',  'Deskripsi Produk') }}
                            {{ Form::textarea('deskripsi', $product->deskripsi, ['class' => 'form-control', 'placeholder' => 'Contoh : Ikan berasal dari Samudra Pasifik', 'autocomplete' => 'off', 'rows'=>'4', 'required']) }}
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            ...
                            {{ Form::number('stok', $product->stok, ['class' => 'form-control', 'placeholder' => 'Contoh : 10', 'autocomplete' => 'off', 'required']) }}
                        </div>
                        <div class="col-lg-6">
                            {{ Form::label('harga',  'Harga Produk') }}
                            <p style="position: absolute; margin-top: 5px; margin-left: 10px;">Rp.</p>
                            {{ Form::number('harga', $product->harga, ['class' => 'form-control', 'style'=>'padding-left: 35px; border-top: none; border-right: none; border-left: none;', 'placeholder' => 'Contoh : Rp. 30000', 'autocomplete' => 'off', 'required']) }}
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-lg-11">
                                    {{ Form::number('berat', $product->berat, ['class' => 'form-control', 'style'=>'border-top: none; border-right: none; border-left: none;', 'step'=>'0.01', 'placeholder' => 'Contoh : 1.5', 'autocomplete' => 'off', 'required']) }}
                                </div>
                                <div class="col-lg-1">
